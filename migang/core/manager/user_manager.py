...
class UserManager:
    ...
    def __get_user(self, user_id: str) -> User:
    ...
    def check_user_plugin_status(self, plugin_name: str, user_id: str) -> bool:
    ...
    def check_plugin_permission(self, plugin_name: str, user_id: str) -> bool:
    ...
    def set_user_permission(self, user_id: str, permission: Permission):
        """设定用户权限
    ...
    def get_user_permission(self, user_id: str) -> Permission:
        """获取用户权限
