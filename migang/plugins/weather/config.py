...
class Config(BaseModel):
    ...
    qweather_apikey: str | None = Field(default=None, deprecated="建议使用更安全的JWT key")
    qweather_apitype: int | None = Field(default=None)
    qweather_hourlytype: HourlyType | None = Field(default=HourlyType.current_12h)
    qweather_forecase_days: int | None = Field(default=7)
    qweather_use_jwt: bool | None = Field(default=True, description="是否使用 JWT，默认 True")
    qweather_jwt_sub: str | None = Field(default=None, description="JWT sub，即控制台中的项目ID")
