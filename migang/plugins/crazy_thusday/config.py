...
async def post_check() -> None:
    ...
    url = "https://mirror.ghproxy.com/https://raw.githubusercontent.com/MinatoAquaCrews/nonebot_plugin_crazy_thursday/master/nonebot_plugin_crazy_thursday/post.json"
